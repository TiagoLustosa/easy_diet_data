...
with open('C:/projects/easy_diet_data/data_files/new_data_mock_to_regression11.json', 'r', encoding="utf8") as input_file:
    userDataJson = json.load(input_file)

with open('C:/projects/easy_diet_data/data_files/user_data_result11.csv', mode='w', newline='') as output_file:
    ...
    for i in userDataJson:
        ...
        if (totalProteinIsOk):
            ...
            with open('user_data__result_with_csv11.json', 'w', encoding='utf-8') as output_file:
